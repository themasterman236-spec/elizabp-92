...
local entity = spawner.Create({
	Entity = {
		Name = "VOID",
		Asset = "https://github.com/themasterman236-spec/elizabp-92/raw/main/VOID.rbxm", -- Đã xác nhận hợp lệ
		HeightOffset = 0
	},
	Lights = {
		Flicker = {
